...
public class MainActivity extends AppCompatActivity
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    //out.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    startActivity(out);
                    //startActivity(new Intent(MainActivity.this, LoginActivity.class));
                    finish();
                    Log.d("Signed IN/out main", "onAuthStateChanged:signed_out");
                }
                // ...
            }
        };
    ...
    public void onStart() {
        super.onStart();
        mainAuth.addAuthStateListener(mAuthListener);
    }
    ...
    public void onStop() {
        ...
        if (mAuthListener != null) {
            mainAuth.removeAuthStateListener(mAuthListener);
        }
    }
}
